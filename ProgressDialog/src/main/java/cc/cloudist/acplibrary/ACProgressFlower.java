...
public class ACProgressFlower extends ACProgressBaseDialog {
    ...
    public void updateProgress(String downloading_text) {
        if (mFlowerView != null)
            mFlowerView.updateText(downloading_text);
    }
        ...
        if (mFlowerView == null) {
            ...
            if (mBuilder.typeface!=null) {
                mFlowerView = new FlowerView(mBuilder.mContext, size, mBuilder.mBackgroundColor, mBuilder.mBackgroundAlpha, mBuilder.mBackgroundCornerRadius
                        ...
                        , mBuilder.mText, mBuilder.mTextSize, mBuilder.mTextColor, mBuilder.mTextAlpha, mBuilder.mTextMarginTop, mBuilder.mTextExpandWidth, mBuilder.typeface);
            }else {
